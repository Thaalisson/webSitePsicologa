...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between relative z-50">
        {/* Logo */}
        ...
        <ul className="hidden md:flex items-center gap-6 font-cormorant text-lg">
          ...
          <li>
            <Menu as="div" className="relative inline-block text-left">
              <Menu.Button className="flex items-center gap-2 text-white hover:text-[#e98c8b]">
          ...
          >
            ...
            <li>
              <Menu as="div" className="relative">
                <Menu.Button className="flex items-center justify-between w-full text-white hover:text-[#e98c8b]">
